...
import { makeupartistes } from "../data/makeupartisteData";
import type { MakeupArtiste } from "../data/makeupartisteData";

const MakupArtistes = () => {
  const [filteredData, setFilteredData] =
    useState<MakeupArtiste[]>(makeupartistes);

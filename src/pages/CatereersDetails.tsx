...
const CatereersDetails = () => {
  ...
  const caterer = Caterers.find((caterer) => caterer.id === Number(id));

  if (!caterer) {
    return <p className="text-center mt-20">Caterer not found</p>;
  }
...
export default CatereersDetails;
